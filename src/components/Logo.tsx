...
export const Logo: React.FC<LogoProps> = ({ 
  ...
  const colors = {
    ...
    dark: {
      icon: 'from-slate-900 to-slate-700',
      text: 'text-slate-900',
  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      <motion.div 
        ...
        className={`relative flex items-center justify-center rounded-[1.25rem] bg-gradient-to-br ${currentColor.icon} shadow-xl shadow-primary/20`}
      ...
      {showText && (
        <div className="flex flex-col -space-y-1">
          <h1 className={`${currentSize.text} font-black font-display tracking-tighter ${currentColor.text}`}>
            Vocalis<span className="text-primary">.</span>
          </h1>
